...
Welcome <%=request.getAttribute("login") %>, to complete registration <a href="/test/views/student/student.jsp">fill in
...
<div class="topnav">
    <a href="/test/views/student/student.jsp">Fill form to finish registration</a>
    <a href="/courseServlet">Show available course</a>
    <a href="/test/views/coursestudent/courseentryform.jsp">Enroll in a course</a>
